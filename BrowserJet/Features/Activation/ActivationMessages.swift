...
enum ActivationMessages {
    ...
    /// Confirmation copy shown after the recovery email has been requested.
    /// Hoisted out of `AccountRecovery` to satisfy the `nesting` rule.
    enum AccountRecoverySuccess {
